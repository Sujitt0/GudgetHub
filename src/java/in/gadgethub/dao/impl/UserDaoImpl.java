...
public class UserDaoImpl implements UserDao {
    ...
    public String registerUser(UserPojo user) {
        ...
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("Insert into users values where ?,?,?,?,?,?");
    ...
    @Override
    public String isVaildCredentials(String emailId, String password) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection conn = DBUtil.provideConnection();
        ...
        try {
            ...
            System.out.println("Error inisValosCredentials");
            ex.printStackTrace();
        }
        DBUtil.closeResultSet(rs);
        DBUtil.closeStatement(ps);
