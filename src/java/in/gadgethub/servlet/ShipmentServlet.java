...
public class ShipmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Check if orderId and productId are valid
        if (orderId != null && !orderId.isEmpty() && productId != null && !productId.isEmpty()) {
...
//            if ("Order has been shipped successfully.".equals(result)) {
//            request.setAttribute("message", "Order has been shipped successfully.");
//               
//            } else {
//               request.setAttribute("message", "Failed to ship the order.");
//               }
//
//            
...
//        } else {
//           request.setAttribute("message", "Invalid order details.");
//           RequestDispatcher dispatcher = request.getRequestDispatcher("shippedItems.jsp");
